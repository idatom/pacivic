...
class Tugu extends StatefulWidget {
  @override
  _TuguState createState() => _TuguState();
}

class _TuguState extends State<Tugu> {
  CollectionReference ref = FirebaseFirestore.instance.collection('tugu');
