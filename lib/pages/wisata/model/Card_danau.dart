...
class CardDanau extends StatefulWidget {
  @override
  _CardDanauState createState() => _CardDanauState();
}

class _CardDanauState extends State<CardDanau> {
  CollectionReference ref = FirebaseFirestore.instance.collection('danau');
