...
class CardGoa extends StatefulWidget {
  @override
  _CardGoaState createState() => _CardGoaState();
}

class _CardGoaState extends State<CardGoa> {
  CollectionReference ref = FirebaseFirestore.instance.collection('goa');
